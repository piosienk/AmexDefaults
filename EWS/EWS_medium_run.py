...
# class_weights=[0.5 for i in range(2)]
...
# with open('./Additional_data/data_train_EWS.pickle', 'rb') as file:
#     data_train = pickle.load(file)
#
# with open('./Additional_data/data_valid_EWS.pickle', 'rb') as file:
#     data_valid = pickle.load(file)

with open('./Additional_data/data_train_EWS_medium.pickle', 'rb') as file:
    data_train = pickle.load(file)

with open('./Additional_data/data_valid_EWS_medium.pickle', 'rb') as file:
    data_valid = pickle.load(file)
...
torch.save(lstm_model, "./Final_models/ews_medium.pickle")