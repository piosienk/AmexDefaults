...
df_x = pd.read_parquet(data_path + "/train_data_woe_merged_medium.parquet")
print(df_x.shape)
...
with open('./Additional_data/selected_features_medium.pickle', 'wb') as file:
...
# Save model
with open('./Final_models/lm_model_medium_obs.pickle', 'wb') as file:
    pickle.dump(lm, file)
