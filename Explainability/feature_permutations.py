...
# Load model
from Explainability.explainability_helpers import calculate_feature_permutation

network_trained = torch.load("../LSTM/Final_models/lstm.pickle")
fp = captum.attr.FeaturePermutation(network_trained)
...
attributions = calculate_feature_permutation(fp, input_test, y_test, n_variables, 1500)
attributions_bad = calculate_feature_permutation(fp, input_bad, y_bad, n_variables, 1500)
attributions_good = calculate_feature_permutation(fp, input_good, y_good, n_variables, 1500)
